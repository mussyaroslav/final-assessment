...
function Card({id, title, description, price, quantity, image}) {
  ...
  const addProduct = () => {
    ...
    removeCase.current.style.display = 'flex'
  }

  const removeProduct = () => {
    dispatch(removeProductsBasket(id))
    removeCase.current.style.display = 'none'
    addCase.current.style.display = 'flex'
  }
  ...
  return (
    <div className='product__card'>
      ...
      <div className='price__btn'>
        ...
        <button ref={addCase} onClick={addProduct} className='btn__plus'>
        ...
        <button ref={removeCase} onClick={removeProduct} className='basket__btn__delete1'>
